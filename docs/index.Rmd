...
```
Five calculated values:
victims_less_than_one(): `r victims_less_than_one()`

male_offenders_count(): `r male_offenders_count()`

female_offenders_count(): `r female_offenders_count()`

black_victim_count(): `r black_victim_count()`

handgun_used_count(): `r handgun_used_count()`
